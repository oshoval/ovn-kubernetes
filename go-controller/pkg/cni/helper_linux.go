...
func setupIngressFilter(gwLLA string) error {
	...
	return setupIngressFilterWithTableAndLifetimeMatcher(nft, gwLLA, rasLifetime)
}

func setupIngressFilterWithTableAndLifetimeMatcher(nft knftables.Interface, gwLLA, rasLifetime string) error {
	const (
		chainName  = "input"
		deviceName = "ovn-udn1"
	)
